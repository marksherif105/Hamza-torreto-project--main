...
bool operator ==(Object other) {
  final _this = this as ResendOtpRequest;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResendOtpRequest&&(identical(other.email, _this.email) || other.email == _this.email));
}
...
String toString() {
  final _this = this as ResendOtpRequest;
  return 'ResendOtpRequest(email: ${_this.email})';
}
