...
int get hashCode {
  final _this = this as RegisterRequest;
  return Object.hash(runtimeType,_this.email,_this.password,_this.firstName,_this.lastName);
}

@override
String toString() {
  final _this = this as RegisterRequest;
  return 'RegisterRequest(email: ${_this.email}, password: ${_this.password}, firstName: ${_this.firstName}, lastName: ${_this.lastName})';
}
...
class _RegisterRequest implements RegisterRequest {
  const _RegisterRequest({required this.email, required this.password, required this.firstName, required this.lastName});
