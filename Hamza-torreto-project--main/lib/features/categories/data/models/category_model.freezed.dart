...
String toString() {
  final _this = this as CategoryModel;
  return 'CategoryModel(id: ${_this.id}, name: ${_this.name}, description: ${_this.description}, coverPictureUrl: ${_this.coverPictureUrl})';
}
...
class _CategoryModel implements CategoryModel {
  const _CategoryModel({required this.id, required this.name, required this.description, required this.coverPictureUrl});
...
@override
String toString() {
    return 'CategoryModel(id: $id, name: $name, description: $description, coverPictureUrl: $coverPictureUrl)';
}
